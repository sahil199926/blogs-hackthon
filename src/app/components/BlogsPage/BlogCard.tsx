...
function BlogCard({blog}:{blog: IBlog}) {
    return (
    <article className="relative bg-Primary-Mordor-Blue-Bg-100 z-20">
          <div className="flex-1 flex flex-col bg-Neutrals-white shadow-lg items-center bg-neutrals-50 lg:flex-row">
            
            <Image
                height={439}
                width={622}
                className="w-full md:w-1/2 h-auto object-contain flex-[0_1_48%]"
                src={blog.image.link}
            ...
            <div className="flex  flex-col py-3 flex-[0_1_48%] ">
                <div className="w-[90%] h-full flex gap-8 flex-col mx-auto justify-around">
                    <div className="flex flex-col gap-2">
                        ...
                        <h3 className="text-base md:text-[32px] md:leading-11 font-semibold">{blog.title}</h3>
                        <p className=" text-sm md:text-base font-normal">{blog.description}</p>
                        <div className="flex flex-row pt-2 gap-3">
                            ...
                            <div className="flex flex-col justify-center">
                                <h4 className="text-base font-semibold">{blog.author.name}</h4>
                                <p className="text-sm font-normal">{blog.author.designation}</p>
                            </div>
                        </div>
                    </div>
                    <div
