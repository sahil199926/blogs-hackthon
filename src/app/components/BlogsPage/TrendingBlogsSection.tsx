...
export default function TrendingBlogsSection({trendingBlogDetails}:{trendingBlogDetails: ITrendingBlogDetails}) {
            ...
            <div
              ...
              <div className="flex flex-col gap-1 max-w-[339px] items-center">
                <div className="flex gap-1 items-center">
                  <Link href={item.link} className="text-Primary-Blue-950 text-Link-medium-16">
<h3>
{item.title}
</h3>
                  </Link>
