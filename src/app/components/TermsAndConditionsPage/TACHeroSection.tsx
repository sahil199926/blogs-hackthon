import { ITACHeroSection } from "@/types";
import DotBg from "../common/DotBg";

function TACHeroSection({ headerSection }: { headerSection: ITACHeroSection }) {
  return (
    <div className="flex justify-center relative bg-Primary-Mordor-Blue-Bg-100 overflow-hidden">
      ...
      <section className="w-full max-w-8xl">
        <div className="p-4 md:px-[88px] md:py-20">
          ...
          <div className="mt-4 md:mt-6 text-[14px] md:text-[16px] text-left leading-5 lg:leading-[24px] text-black/70"
